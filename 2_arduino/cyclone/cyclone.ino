...
#define NUM_LEDS 63  //Total Number of LED
#define DATA_PIN 5   //Cyclone LED Strip D2
...
void setup() {
  ...
  FastLED.addLeds<WS2812B, SCORE_PIN, RGB>(sleds, SCORE_LEDS);
...
void loop() {
  ...
  if (gameState == 0) {
    fill_rainbow(leds, NUM_LEDS, 0, 4); //2 = longer gradient strip
